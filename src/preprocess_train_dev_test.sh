...
python src/convert_data.py -i ${INPUT_DIR}/TEST.prep_feedback_comment.public.tsv -m ${INPUT_DIR}/spm.model -o ${INPUT_DIR}/TEST --test

fairseq-preprocess \
    --trainpref ${INPUT_DIR}/TRAIN --validpref ${INPUT_DIR}/DEV --testpref ${INPUT_DIR}/TEST \
...
cp ${INPUT_DIR}/TEST.err ${OUTPUT_DIR}/test.src-com.err
